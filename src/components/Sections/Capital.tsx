...
const CapitalRaisingCard = ({ deal }) => {
  const { title, type, raised, goal, investors, pending, status, gradient, statusColor } =
    deal;
...
const Capital = () => {
  return (
    <main className="flex-1 p-8 bg-gray min-h-screen">
      {/* Title + Action */}
      ...
      <section>
        ...
        <div className="bg-gray rounded-2xl border border-gray-800 overflow-hidden shadow-md">
          <table className="w-full text-left">
            <thead className="bg-gray border-b border-gray-800">
              <tr>
