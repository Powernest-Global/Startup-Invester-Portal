...
const stats = [
    { label: "Senior Frontend Designer", value: "23", gradient: 'from-[#0C0D17] via-[#0C0D17] to-[#102361]' },
    { label: "Product Manager", value: "18", gradient: 'from-[#0C0D17] via-[#0C0D17] to-[#102361]'},
    { label: "Growth Market", value: "16", gradient: 'from-[#0C0D17] via-[#0C0D17] to-[#102361]' },
    { label: "Backend Engineers", value: "31", gradient: 'from-[#0C0D17] via-[#0C0D17] to-[#102361]' },
      ...
      {[1, 2, 3, 4, 5].map((star) => (
        <span
          ...
          className={`cursor-pointer transition-colors duration-200 ${
            (hover || rating) >= star ? 'text-orange-400' : 'text-gray-500'
          }`}
        >
          ★
        </span>
...
<div className="flex flex-col items-start p-4 gap-4 w-[540px] h-[280px] rounded-xl bg-gradient-to-br from-[#0C0D17] via-[#0C0D17] to-[#102361]">
 ...
 />
  ...
  {/* Right Block */}
      <div className="flex flex-col justify-center items-start w-[70px] h-[70px] rounded-md">
        <StarRating />
      </div>
    </div>
        {/* Pill Row */}
